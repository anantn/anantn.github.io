...
_See also:_
<br/>
<img class="inline" src="/images/talks.svg" /> [Enterprise Scale Knowledge Graphs](/talks#2018-kg)
</div>
...
_See also:_
<br/>
<img class="inline" src="/images/talks.svg" /> [Building an Intelligent Assistant](/talks#2017-assistant)
<ul>
<li><img class="inline" src="/images/blog.svg" /></li>
...
_See also:_
<br/>
<img class="inline" src="/images/talks.svg" /> [πp](/talks#2010-piep) , [Glendix: The Why and The How](/talks#2008-glendix) , [Unix++: Plan 9 from Bell Labs](/talks#2007-plan92) and [Introducing Plan 9](/talks#2007-plan91)
<ul>
<li><img class="inline" src="/images/blog.svg" /></li>
{% for post in site.posts %}
...
Over time, I found myself with lesser free time, so the practically of Ubuntu on the Desktop and a Macbook Pro on-the-go eventually won over.

<div class="also">
_See also:_
<br/>
<img class="inline" src="/images/talks.svg" /> [Making Gentoo Tick](/talks#2007-gentoo)
<ul>
<li><img class="inline" src="/images/blog.svg" /></li>
{% for post in site.posts %}
...
<div class="prose">
After contributing code for proper signal handling in [GNU Parted](https://www.gnu.org/software/parted/), I was briefly the maintainer of the project for a little over a year. Parted is a partition manager is an is widely used on most Linux distributions, notably in the default installer for Ubuntu.
